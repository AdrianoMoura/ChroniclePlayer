...
Originally tracked toward a `0.2.3` patch (see `../tracker-current.md`'s prior "Current
target" line and `tracker-history/v0.2.2.md`'s own carry-forward note, which already
...
forward again — see `../tracker-current.md`. A small, standalone same-day UI tweak
