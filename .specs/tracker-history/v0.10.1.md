...
plus a red-heart indicator for the viewer's own existing like state, confirmed working
live by the owner) — full D-062 narrative is in `decisions.md`, not this file.
