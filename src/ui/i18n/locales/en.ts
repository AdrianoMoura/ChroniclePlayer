...
export const dict = {
  ...
  'help.action.addToPlaylist': 'add to playlist',
  ...
  'player.upNext.labelPlaylist': 'Next in {name}',
  ...
  'sidebar.channelSort.recent': 'Recent',
  'sidebar.channelSort.unread': 'Unread',
  ...
  'playlists.createButton': '+ New Playlist',
  'playlists.emptyTitle': 'No playlists yet.',
  'playlists.emptyHint': 'Use “Add to Playlist” on any video to start one.',
  'playlists.videoCount': '{count} video{plural}',
  'playlists.dialog.createTitle': 'New playlist',
  'playlists.dialog.nameLabel': 'Name',
  'playlists.dialog.namePlaceholder': 'Playlist name',
  'playlists.dialog.descriptionLabel': 'Description',
  'playlists.dialog.descriptionPlaceholder': 'Description (optional)',
  ...
  'playlistDetail.saveTitle': 'Save',
  'playlistDetail.cancelEditTitle': 'Cancel',
  'playlistDetail.deleteButton': 'Delete playlist',
  'playlistDetail.confirmDelete': 'Click again to confirm',
  'playlistDetail.empty': 'This playlist is empty.',
