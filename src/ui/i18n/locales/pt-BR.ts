...
export const dict: Partial<Dict> = {
  ...
  'help.action.addToPlaylist': 'adicionar à playlist',
  ...
  'player.upNext.labelPlaylist': 'Próximo em {name}',
  ...
  'sidebar.channelSort.recent': 'Recentes',
  'sidebar.channelSort.unread': 'Não lidos',
  ...
  // Playlists — apenas locais, nunca sincronizadas com o YouTube.
  'playlists.createButton': '+ Nova playlist',
  'playlists.emptyTitle': 'Nenhuma playlist ainda.',
  'playlists.emptyHint': 'Use "Adicionar à playlist" em qualquer vídeo para criar uma.',
  'playlists.videoCount': '{count} vídeo{plural}',
  'playlists.dialog.createTitle': 'Nova playlist',
  'playlists.dialog.nameLabel': 'Nome',
  'playlists.dialog.namePlaceholder': 'Nome da playlist',
  'playlists.dialog.descriptionLabel': 'Descrição',
  'playlists.dialog.descriptionPlaceholder': 'Descrição (opcional)',
  ...
  'playlistDetail.saveTitle': 'Salvar',
  'playlistDetail.cancelEditTitle': 'Cancelar',
  'playlistDetail.deleteButton': 'Apagar playlist',
  'playlistDetail.confirmDelete': 'Clique novamente para confirmar',
  'playlistDetail.empty': 'Esta playlist está vazia.',
